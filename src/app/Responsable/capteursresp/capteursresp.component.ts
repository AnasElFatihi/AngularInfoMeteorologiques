...
@Component({
  selector: 'app-capteursresp',
  templateUrl: './capteursresp.component.html',
  styleUrls: ['./capteursresp.component.css']
})
export class CapteursrespComponent implements OnInit {
  ...
  ajouterCapteur(e) {
    ...
    if (this.capteur.libelle !== undefined && this.capteur.etat !== undefined && this.capteur.dateinstall !== undefined && this.capteur.marque !== undefined && this.capteur.region !== undefined) {
      this.capteursService.ajouterCapteur2(this.capteur, this.regionname).subscribe(( data ) => {
        console.log(data);
